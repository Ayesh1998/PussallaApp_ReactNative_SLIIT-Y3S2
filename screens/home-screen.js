...
const HomeScreen = (props) => {
  ...
  const meats = [{
    ...
    title: "Chicken Range",
    count: "5",
    image: "https://c7.alamy.com/comp/T85KHD/fresh-meat-products-in-butcher-shop-T85KHD.jpg"
  },
  ...
  const renderItemsFunction = (itemData) => {
    return (
      <TouchableOpacity style={styles.item}
                        onPress={
                          () => {
                            props.navigation.navigate("CategoriesProducts", {
  ...
  return (
    ...
    <View style={styles.main}>
      ...
      <SectionList
        ...
        renderSectionHeader={
          ({section}) => <Text
            style={{marginTop: 5, fontWeight: "bold", fontSize: 14, color: "black"}}>{section.title}</Text>
        }
